    ...
    return function(scriptId, scriptName, configSchema = null, changelog = null, debugEnabled = true, remoteConfig = null) {
        ...
        const settingsInterface = {
            ...
            showModal: function() {
                ...
                // didDrag tracks whether the mouse actually moved while dragging.
                // Without this, releasing the mouse outside the overlay after a drag
                // fires a 'click' on the overlay which would wrongly close the dialog.
                let didDrag = false;
                ...
                overlay.addEventListener('click', e => {
                    if (e.target === overlay) {
                        // Ignore the click that terminates a drag-then-release-outside sequence
        ...
        const changelogInterface = {
            ...
            show: function() {
                ...
                // Focus the dialog as soon as it finishes opening so Escape works immediately
                requestAnimationFrame(() => requestAnimationFrame(() => entriesWrap.focus()));
                ...
                overlay.addEventListener('mousedown', e => {
                    if (e.target === overlay && !isDragging && !isResizing && !didDrag) closeDialog();
                });
