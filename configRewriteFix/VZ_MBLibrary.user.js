            ...
            showModal: function() {
                ...
                Object.entries(configSchema).forEach(([key, cfg]) => {
                    ...
                    <div class="vz-setting-row"
                        ...
                        ">
                            <label for="${inputId}"
                                   style="font-size:0.85em;font-weight:500;color:#334;
                        ...
                        <div style="
                            ...
                            box-sizing:border-box;
                        ">
                            ${isPopupDialog ? '<em>(pipe-sep.)</em>' : escAttr(String(cfg.default))}
                        </div>
                        <div style="
                            flex:1 1 0;
                            min-width:0;
