        ...
        const settingsInterface = {
            ...
            showModal: function() {
                ...
                Object.entries(configSchema).forEach(([key, cfg]) => {
                    ...
                    col1.style.cssText = 'flex:0 0 280px;width:280px;min-width:0;padding:10px 14px;display:flex;align-items:center;flex-wrap:wrap;gap:6px;border-right:1px solid #e4e8ef;box-sizing:border-box;';
                ...
                container.innerHTML = `
                    ...
                    <div id="${scriptId}-drag-header"
                        ...
                        <div style="
                            ...
                            /* Changed: Only a bottom border to match rows, or ensure parent has the side borders */
                            border-bottom: 1px solid #d0d5dd; 
                            overflow:hidden;
                            font-size:0.78em;
                            font-weight:700;
                        ...
                        ">
                            <div style="flex:0 0 280px;width:280px;padding:6px 14px;border-right:1px solid #d0d5dd;box-sizing:border-box;">Setting</div>
