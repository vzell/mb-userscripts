...
// CHANGELOG
let changelog = [
    {version: '10.0.0+2026-02-15', description: 'Code reorganization: Moved changelog, SCRIPT_ID, SCRIPT_NAME, configSchema, and pageDefinitions to the beginning of the file for better code organization and readability.'},
    {version: '9.1.1+2026-02-15', description: 'Fix: Status display now correctly shows sorting/filtering results with table name and column info. Fixed ReferenceError that caused "Sort failed" and "Filtering..." to persist incorrectly.'},
