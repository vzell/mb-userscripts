...
(function() {
    ...
    document.addEventListener('keydown', (e) => {
        ...
        if (isPrefixKeyEvent(e)) {
            ...
            if (typeof Lib !== 'undefined' && Lib.debug) {
                ...
                Lib.debug('shortcuts', 'Function shortcuts: r=Resize, t=Statistics, s=Save, d=Density, v=Visible, e=Export, l=Load, k=Shortcuts Help, h=App Help, ,=Settings' + (ctrlMFunctionMap['o'] ? ', o=Stop' : ''));
                ...
                console.log('[ShowAllEntityData] Function shortcuts: r=Resize, t=Statistics, s=Save, d=Density, v=Visible, e=Export, l=Load, k=Shortcuts Help, h=App Help, ,=Settings' + (ctrlMFunctionMap['o'] ? ', o=Stop' : ''));
            }
        ...
        const sections = [
            ...
            },
            {
                ...
                shortcuts: [
                    ...
                    { keys: getShortcutDisplay('sa_shortcut_open_statistics', 'Ctrl+T'), desc: 'Open "Statistics" panel' },
    ...
    ctrlMFunctionMap = {
        ...
        'r': { fn: toggleAutoResizeColumns, description: 'Resize Columns' },
        'v': { fn: openVisibleColumnsMenu, description: 'Open Visible Menu' },
