...
// CHANGELOG
let changelog = [
    {version: '9.18.1+2026-02-15', description: 'Debug: Added console logging to settings button to diagnose why it\'s not finding the exposed library methods. Button now tries: (1) Lib.showSettings(), (2) Lib.settingsInterface.showModal(), (3) fallback to menu link click.'},
