...
(function() {
    ...
    const pageDefinitions = [
        ...
        // Release pages
        {
            // Root release page: shows disc/media table with "Tracks" column
            // (e.g. /release/4865fa3a-ee89-454e-97b6-796b851ae19)
            type: 'release-tracklist',
            match: (path) => !!path.match(/\/release\/[a-f0-9-]{36}\/?$/),
