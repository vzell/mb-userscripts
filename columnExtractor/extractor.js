...
// CHANGELOG
let changelog = [
    {version: '9.66.1+2026-02-22', description: 'Revert: removed the erroneous release-tracklist page definition (type, match, buttons, features, tableMode, non_paginated) that was added in 9.66.0 based on an incorrect URL example (/release/ instead of /label/). The sumTracks extractor in ColumnDataExtractor and the full columnExtractors infrastructure remain intact; the correct page definition for the label URL will be added in a subsequent version.'},
