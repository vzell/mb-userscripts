    ...
    return function(scriptId, scriptName, configSchema = null, changelog = null, debugEnabled = true, remoteConfig = null) {
        ...
        const changelogInterface = {
            ...
            show: function() {
                ...
                // Focus the search/filter input when the dialog opens so the user can
                // start typing a filter immediately, and Escape works as expected.
