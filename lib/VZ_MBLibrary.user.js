...
const LIBRARY_VERSION = '3.13.2+2026-02-27';

// CHANGELOG
// let changelog_library = [
//     {version: '3.13.2+2026-02-27', description: 'Fix hidden up-arrow on number inputs in the Settings dialog. The input had padding:4px 6px which left only 4 px of vertical padding above the browser-rendered spin-button widget; the top of the up-arrow was clipped behind the border area. Fixed by replacing the vertical padding with an explicit height:26px; padding:0 6px; box-sizing:border-box — the full interior height (26 px minus the 2 px border) is now available to both arrows so neither is clipped.'},
