            ...
            showModal: function() {
                ...
                container.innerHTML = `
                    ...
                    <div>
                        ...
                        <h4 style="text-shadow: white 0px 0px 8px; font-size: 1.5em; margin-top: 0;">
                            ${scriptName.toUpperCase()}
                        </h4>
                        <p style="margin-bottom: 10px;">
                            <strong>Settings are applied immediately upon saving.</strong>
                        </p>
                    </div>
                    ...
                    <div style="flex: 1; overflow-y: auto; margin: 10px 0;">
                        <table border="2" cellpadding="4" cellspacing="1"
                            style="width: 100%; border-collapse: separate; background: #eee;">
                            <thead style="position: sticky; top: 0; background: #ccc; z-index: 2;">
