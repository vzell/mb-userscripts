...
'use strict';
// ==UserScript==
// @name         VZ: MusicBrainz - Common Functions For Loujine Userscripts
// @namespace    https://github.com/vzell/mb-userscripts
// @version      1.0+2025-12-01
// @description  Common functions for loujine userscripts
...
class RelationshipEditor {
  ...
  container(node) {
    const container = document.getElementById('loujine-vzell-menu');
    if (container !== null) {
	return container;
    }
    // Inject common styles and the main container
    node.insertAdjacentHTML('afterend', `
      <div id="loujine-vzell-menu"
          style="background-color: #f5f5f5;
                 padding: 8px; margin: 0px -6px 6px;
                 border: 5px solid rgb(115, 109, 171);">
          ${this.commonButtonStyle()}
          <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 8px;">
              <h2 style="margin: 0; font-size: 1.0em;">loujine GM tools (adapted by <a href="https://github.com/vzell/mb-userscripts" target="_blank">vzell</a>)</h2>
              <a href="${wikiUrl}" target="_blank">documentation</a>
          </div>
      </div>
    `);
    return document.getElementById('loujine-vzell-menu');
  }
