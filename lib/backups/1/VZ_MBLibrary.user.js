...
const LIBRARY_VERSION = '3.14.0+2026-03-04';
    ...
    return function(scriptId, scriptName, configSchema = null, changelog = null, debugEnabled = true, remoteConfig = null) {
        ...
        const changelogInterface = {
            ...
            show: function() {
                ...
                /**
                 * Show or hide the clear button depending on whether the search field
                 * has any content.
                 */
                const updateClearBtn = () => {
                    clClearBtn.style.display = searchInput.value ? 'block' : 'none';
                };
                ...
                // Clear button: wipe the filter and re-render
                ...
                container.querySelector(`#${scriptId}-changelog-close`).onclick = () => {
                    // When a filter is active, CLOSE clears it rather than dismissing the dialog.
                    // Only when the search field is already empty does CLOSE close the dialog.
                ...
                //   3. Search field NOT focused + has text → clear text (same as CLOSE behaviour)
                //   4. Otherwise                        → close the dialog
                //
                ...
                // stopImmediatePropagation() in cases 1–3 prevents any other handler reacting.
                clEscHandler = (e) => {
                    if (e.key !== 'Escape') return;
                    if (searchInput && document.activeElement === searchInput) {
                        ...
                        // Filter active but search not focused — clear without closing
                        e.stopImmediatePropagation();
                        e.preventDefault();
                        searchInput.value = '';
                        searchInput.dispatchEvent(new Event('input'));
