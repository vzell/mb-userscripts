...
// CHANGELOG
let changelog = [
    {version: '9.34.1+2026-02-17', description: 'Enhancement: Ctrl-M keyboard shortcut now available on page entry. Previously only worked after tables were rendered. Extracted Ctrl-M handler to separate event listener that activates immediately when keyboard shortcuts are initialized, allowing "Show all" action button trigger even before page rendering completes.'},
...
(function() {
    ...
    function initKeyboardShortcuts() {
        ...
        // Handle Ctrl/Cmd + M: Click first "Show all" action button
        // This handler is added separately so it works on page entry, not just after rendering
        const handleCtrlM = (e) => {
        ...
        // Add Ctrl-M handler immediately (available on page entry)
