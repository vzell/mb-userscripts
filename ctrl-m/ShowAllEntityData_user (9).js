...
// CHANGELOG
let changelog = [
    {version: '9.34.1+2026-02-17', description: 'Enhancement: Ctrl-M keyboard shortcut now available on page entry. Previously only worked after tables were rendered. Moved Ctrl-M handler to execute immediately when script loads (at IIFE start), before any DOM monitoring or rendering begins. Now available from the moment the page loads.'},
...
(function() {
    ...
    // Initialize Ctrl-M handler immediately for page entry (before rendering)
    // This allows triggering "Show all" button even before tables are rendered
