...
// CHANGELOG
let changelog = [
    {version: '2.3.1+2026-02-07', description: 'Fix detection of filtered Artist-Relationships pages (link_type_id) to allow proper pagination instead of treating them as overview pages.'},
