...
// CHANGELOG
let changelog = [
    {version: '9.35.0+2026-02-17', description: 'Major Enhancement: Multi-column sorting for single-table pages. Click multiple sort icons to build a multi-level sort (primary, secondary, tertiary, etc.). Visual indicators show sort order with superscripts: ▲¹ (primary ascending), ▼² (secondary descending), etc. Click same icon again to remove column from sort. Shift+Click on reset icon (⇅) to clear entire multi-sort. Status display shows all sorted columns. Multi-table pages continue using single-column sort. Tooltips updated to explain multi-column behavior.'},
...
(function() {
     ...
     * For single-table pages, supports multi-column sorting with visual order indicators.
     *
