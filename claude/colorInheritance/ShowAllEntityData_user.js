...
(function() {
    ...
    function gfBorderActive()    { return Lib.settings.sa_global_filter_border_active || '#888888'; }
     ...
     * Note: explicit color:#333 is required to prevent these labels from inheriting
     * the h2 element's orange text colour when filterContainer is a child of the h2.
     */
...
<div style="color:#555; margin-bottom:18px; font-size:0.9em;">${error}</div>`;
    ...
    // explicit color:#333 prevents all child elements from inheriting the h2's orange
    // text colour (set by MusicBrainz site CSS) when filterContainer lives inside an h2.
    filterContainer.style.cssText = 'display:none; align-items:center; white-space:nowrap; gap:5px; color:#333;';
